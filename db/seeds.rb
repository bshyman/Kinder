...
User.create!(first_name: "Amanda", last_name: "Lin", username:"amanda", password:"1234", email: "adnama.lin@gmail.com", zipcode: 60616, radius: 10)
User.create!(first_name: "Benji", last_name: "Shyman", username:"benji", password:"1234", email: "bshyman@gmail.com", zipcode: 60616, radius: 5)
User.create!(first_name: "Vivien", last_name: "Kuo", username:"vi", password:"1234", email: "vi@gmail.com", zipcode: 60616, radius: 1)
User.create!(first_name: "Leland", last_name: "Meiners", username:"leland", password:"1234", email: "leland@gmail.com", zipcode: 60616, radius: 10)
